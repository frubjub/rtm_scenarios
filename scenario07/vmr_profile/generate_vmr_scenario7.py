...
def c(z,c0):
#	"""returns an exponential profile of altitude with scale height 1000m"""
	"""returns an exponential profile of altitude with scale height 600m"""
	return c0 * math.exp(-z/600.0)
	#return c0 * math.exp(-z/1000.0)
...
c_solution = fsolve(vfunc,c_guess,(0,20000))
#print c_solution
